// ===============================
// 1. DADOS (Responsável apenas por armazenar dados)
// ===============================
export const produtosMock = [
    { id: 1, name: "Banana Orgânica", category: "Frutas", desc: "Banana Organica, fresca e direto da fazenda para sua mesa, colhida de forma sustentável.", price: 4.80, unit: "kg", stock: 150, producer: "Fazenda Feliz", rating: 4.89, state: "SP", city: "Campinas", distance: 5.6, img: "https://ceagesp.gov.br/wp-content/uploads/2019/12/Banana_pratapng.png" },
    { id: 2, name: "Maçã Fuji Premium", category: "Frutas", desc: "Maçãs crocantes, selecionadas manualmente com alto padrão de qualidade.", price: 7.50, unit: "kg", stock: 80, producer: "Sítio das Frutas", rating: 3.5, state: "MG", city: "Poços de Caldas", distance: 45.2, img: "https://cdn.pixabay.com/photo/2016/08/12/22/38/apple-1589874_640.jpg" },
    ...
    { id: 5, name: "Feijão Carioca Novo", category: "Grãos", desc: "Feijão colhido recentemente, cozinha rápido e tem caldo grosso.", price: 8.90, unit: "kg", stock: 300, producer: "Fazenda Sol", rating: 4.2, state: "PR", city: "Londrina", distance: 95.0, img: "https://www.embrapa.br/documents/58057223/65438219/acfeijao_pre_prod_cultivares_carica_fig+14_notavel.jpg/09f8431f-3d62-cfaa-b183-d2fd83006c64?t=1633998959630" },
    { id: 6, name: "Tomate Carmem", category: "Vegetais", desc: "Tomates maduros, ideais para saladas e molhos rústicos.", price: 6.20, unit: "kg", stock: 60, producer: "Horta Urbana", rating: 2.8, state: "SP", city: "São Paulo", distance: 11.2, img: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=400&q=80" }
];
